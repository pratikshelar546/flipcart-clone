...
const OrderDetails = () => {
  ...
  // console.log(OrderDetails?.map((item)  =>console.log(item?.orderItems)));
  const newDetails = OrderDetails?.flatMap((item) => item?.orderItems);
...
const [status,setStatus] = useState('')
  const updateOrderSubmitHandler = (e) => {
      ...
      dispatch(updateStatus(isData?.id,status)).then((data)=>console.log(data))
//  console.log(status);
  };
      ...
      <div className="flex flex-col items-center justify-center ">
        ...
        {!isClicked ? (
          ...
          <div>
            {responseProduct && (
              <>
                <h1 className=" text-center">{responseProduct._id}</h1>
                <div className="w-full max-w-5xl p-5 shadow bg-white">
                  <div className="flex flex-row ">
                    ...
                    <div className="flex flex-col">
                      ...
                      <p>
                        Phone Number :-{responseProduct.shippingInfo.phoneNo}
                      </p>
                      <div className="pt-3">
